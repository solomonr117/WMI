...
<div class="seller_page_container">
       <header class="seller_page__header">
        <nav class="seller_page__nav">
          <span class="seller_page__logo"><a href="home/home.php" class="seller_page__logo">WMI</a> </span>
          <ul class="seller_page__ul">
            ...
            <li class="seller_page__list"><a href="orders.php"     class="seller_page__anchor">Orders</a></li>
            <li class="seller_page__list"><a href="home/home.php#contact"     class="seller_page__anchor">Contact</a></li>
            <li class="seller_page__list"><a href="home/home.php#about"       class="seller_page__anchor">About</a></li>
          </ul>
        </nav>
       </header>
